...
| 1.3 | Same group | **Workflow access:** 22 workflows (all on `develop`, including `PLYS-NETWORK/plys-dev-ops/.github/workflows/deploy-dev.yml@refs/heads/develop`) — [§4.7 full list](../vps-started/02-self-hosted-runner.md#47-workflow-access--full-copy-paste-lists) |
